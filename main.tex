...
\newline \newline
This project investigates state-of-the-art methods in image segmentation, object tracking, and develops a novel architecture for cyclist path prediction. The results of which, although not real-time provide a solid foundation for future research in the area and suggests potential modifications to the system for that to become a reality.
\end{abstract}

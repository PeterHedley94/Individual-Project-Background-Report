...
\noindent \begin{table}[h!]
	...
	\begin{tabular}{|p{3.0cm}|p{3.0cm}|p{3.0cm}|p{3.0cm}|}
		\hline
		\textbf{Best Performing}&\textbf{LSTM 1 Size} & \textbf{LSTM 2 Size} &  \textbf{Validation Loss}       \\ \hline
...
The best result from Table \ref{pose_bayes_table} was then taken forward as the final dimensions for the network, and is used in the complete model.
